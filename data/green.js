const GREEN_DATA = [
  {
    ...
    cards: [
      ...
      {
        id: "g1_04",
        front: "WOULD for past habit (advanced use):\n\n'Every summer we would visit my grandparents.'\n\nDifference from USED TO?",
        back: "WOULD = past habit (actions only)\nUSED TO = past habit OR past state\n\n'I used to be shy.' ✅\n'I would be shy.' ❌ (state — can't use would)\n\n📌 would = repeated actions · used to = actions AND states"
      },
      {
        id: "g1_05",
  ...
  {
    section: 3,
    title: "Modals & Semi-modals (Advanced)",
    units: "15–20",
    cards: [
      {
        id: "g3_01",
  ...
  {
    section: 4,
    title: "Linking verbs, Passives, Questions",
    units: "21–27",
    cards: [
      {
        id: "g4_01",
  ...
  },
  {
    ...
    cards: [
      ...
      {
        id: "g5_03",
        front: "Verb + object + to-infinitive:\n\n'I want ___ to leave.'\n'I want him ___ to leave.'\n\nSame or different structure?",
        back: "Different!\n\n'I want TO LEAVE.' (no object → I leave)\n'I want HIM TO LEAVE.' (object → he leaves)\n\n📌 want/need/expect/ask/tell/order/allow + obj + to inf\nObject is the subject of the infinitive action"
      }
    ]
  },
  {
    section: 6,
    title: "Reporting (Advanced)",
    units: "32–39",
    cards: [
      {
        id: "g6_01",
      ...
      {
        id: "g6_03",
        front: "Backshift — when can you skip it?\n\n'She said she IS happy.' vs 'She said she WAS happy.'\n\nAre both correct?",
        back: "Both can be correct!\n\nBackshift optional when:\n· The situation is still true now\n· Reporting immediately after\n\n'She said she is happy.' ✅ (still true)\n'She said she was happy.' ✅ (standard backshift)\n\n📌 Backshift is not always obligatory — context matters"
      }
    ]
  },
  {
    section: 7,
    title: "Nouns (Advanced)",
    units: "40–43",
    cards: [
      {
        id: "g7_01",
  ...
  },
  {
    ...
    cards: [
      ...
      {
        id: "g12_02",
        front: "IN CASE vs IF — difference?\n\n'Take an umbrella ___ it rains.'\n\nAre they interchangeable?",
        back: "NOT interchangeable!\n\n'Take an umbrella IN CASE it rains.' = precaution (take it now regardless)\n'Take an umbrella IF it rains.' = condition (only if it actually rains)\n\n📌 in case = do something now to prepare for a possibility\nif = do something only when the condition is met"
      },
      {
        id: "g12_03",
  ...
  },
  {
    ...
    cards: [
      ...
      {
        id: "g13_02",
        front: "Preposition at end of sentence — correct?\n\n'Who are you talking to?'\nvs\n'To whom are you talking?'",
        back: "Both correct!\n\n'Who are you talking TO?' = natural everyday English\n'To WHOM are you talking?' = formal/old-fashioned\n\n📌 'Never end a sentence with a preposition' is a myth\nNatural English regularly ends with prepositions"
      },
      {
        id: "g13_03",
